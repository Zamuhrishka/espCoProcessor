...
uint8_t convert_day_of_week_to_num(char* day)
{
	uint8_t nday = 0;

	assert(NULL != day);

	if(strstr(day, "Sun") != NULL)
	{
		nday = 1;
	}
	else if(strstr(day, "Mon") != NULL)
	{
		nday = 2;
	}
	else if(strstr(day, "Tue") != NULL)
	{
		nday = 3;
	}
	else if(strstr(day, "Wed") != NULL)
	{
		nday = 4;
	}
	else if(strstr(day, "Thu") != NULL)
	{
		nday = 5;
	}
	else if(strstr(day, "Fri") != NULL)
	{
		nday = 6;
	}
	else if(strstr(day, "Sat") != NULL)
	{
		nday = 7;
	}
...
uint8_t convert_month_to_num(char* month)
{
	uint8_t nmonth = 0;
	...
	else if(strstr(month, "Sept") != NULL)
	{
		nmonth = 9;
	}
