...
typedef enum
{
	ESP_SOCKET_CLIENT        		=       '0',								///< Create the TCP client
	ESP_SOCKET_SERVER       		=       '1',								///< Create the TCP server
}	esp_socket_type_t;
//! @}
...
/**
* @brief 	This function create and open new socket.
*
...
/**
* @brief 	This function close and delete socket.
*
